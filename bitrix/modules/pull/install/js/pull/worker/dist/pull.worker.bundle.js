...
(function (exports) {
	...
	class ChannelManager {
	  constructor(params) {
	    var _params$restClient;
	    this.publicIds = {};
	    this.restClient = (_params$restClient = params.restClient) != null ? _params$restClient : BX.rest;
	...
	})(typeof window === "object" && window || typeof self === "object" && self || undefined);
	...
	(function ($protobuf) {
	  ...
	  $root.RequestBatch = function () {
	    ...
	    RequestBatch.encode = function encode(message, writer) {
	      ...
	      if (message.requests != null && message.requests.length) for (var i = 0; i < message.requests.length; ++i) $root.Request.encode(message.requests[i], writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.Request = function () {
	    ...
	    Request.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.incomingMessages != null && message.hasOwnProperty("incomingMessages")) $root.IncomingMessagesRequest.encode(message.incomingMessages, writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      if (message.channelStats != null && message.hasOwnProperty("channelStats")) $root.ChannelStatsRequest.encode(message.channelStats, writer.uint32( /* id 2, wireType 2 =*/18).fork()).ldelim();
	      if (message.serverStats != null && message.hasOwnProperty("serverStats")) $root.ServerStatsRequest.encode(message.serverStats, writer.uint32( /* id 3, wireType 2 =*/26).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.IncomingMessagesRequest = function () {
	    ...
	    IncomingMessagesRequest.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.messages != null && message.messages.length) for (var i = 0; i < message.messages.length; ++i) $root.IncomingMessage.encode(message.messages[i], writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.IncomingMessage = function () {
	    ...
	    IncomingMessage.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.receivers != null && message.receivers.length) for (var i = 0; i < message.receivers.length; ++i) $root.Receiver.encode(message.receivers[i], writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      if (message.sender != null && message.hasOwnProperty("sender")) $root.Sender.encode(message.sender, writer.uint32( /* id 2, wireType 2 =*/18).fork()).ldelim();
	      if (message.body != null && message.hasOwnProperty("body")) writer.uint32( /* id 3, wireType 2 =*/26).string(message.body);
	      if (message.expiry != null && message.hasOwnProperty("expiry")) writer.uint32( /* id 4, wireType 0 =*/32).uint32(message.expiry);
	      if (message.type != null && message.hasOwnProperty("type")) writer.uint32( /* id 5, wireType 2 =*/42).string(message.type);
	      return writer;
	    };
	  ...
	  $root.ChannelStatsRequest = function () {
	    ...
	    ChannelStatsRequest.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.channels != null && message.channels.length) for (var i = 0; i < message.channels.length; ++i) $root.ChannelId.encode(message.channels[i], writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.ChannelId = function () {
	    ...
	    ChannelId.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.id != null && message.hasOwnProperty("id")) writer.uint32( /* id 1, wireType 2 =*/10).bytes(message.id);
	      if (message.isPrivate != null && message.hasOwnProperty("isPrivate")) writer.uint32( /* id 2, wireType 0 =*/16).bool(message.isPrivate);
	  ...
	  $root.Sender = function () {
	    ...
	    Sender.encode = function encode(message, writer) {
	      ...
	      if (message.id != null && message.hasOwnProperty("id")) writer.uint32( /* id 2, wireType 2 =*/18).bytes(message.id);
	      return writer;
	    };
	  ...
	  $root.ResponseBatch = function () {
	    ...
	    ResponseBatch.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.responses != null && message.responses.length) for (var i = 0; i < message.responses.length; ++i) $root.Response.encode(message.responses[i], writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.Response = function () {
	    ...
	    Response.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.outgoingMessages != null && message.hasOwnProperty("outgoingMessages")) $root.OutgoingMessagesResponse.encode(message.outgoingMessages, writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      if (message.channelStats != null && message.hasOwnProperty("channelStats")) $root.ChannelStatsResponse.encode(message.channelStats, writer.uint32( /* id 2, wireType 2 =*/18).fork()).ldelim();
	      if (message.serverStats != null && message.hasOwnProperty("serverStats")) $root.JsonResponse.encode(message.serverStats, writer.uint32( /* id 3, wireType 2 =*/26).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.OutgoingMessagesResponse = function () {
	    ...
	    OutgoingMessagesResponse.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.messages != null && message.messages.length) for (var i = 0; i < message.messages.length; ++i) $root.OutgoingMessage.encode(message.messages[i], writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.OutgoingMessage = function () {
	    ...
	    OutgoingMessage.encode = function encode(message, writer) {
	      ...
	      if (message.expiry != null && message.hasOwnProperty("expiry")) writer.uint32( /* id 3, wireType 0 =*/24).uint32(message.expiry);
	      if (message.created != null && message.hasOwnProperty("created")) writer.uint32( /* id 4, wireType 5 =*/37).fixed32(message.created);
	      if (message.sender != null && message.hasOwnProperty("sender")) $root.Sender.encode(message.sender, writer.uint32( /* id 5, wireType 2 =*/42).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.ChannelStatsResponse = function () {
	    ...
	    ChannelStatsResponse.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.channels != null && message.channels.length) for (var i = 0; i < message.channels.length; ++i) $root.ChannelStats.encode(message.channels[i], writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
	      return writer;
	    };
	  ...
	  $root.ChannelStats = function () {
	    ...
	    ChannelStats.encode = function encode(message, writer) {
	      ...
	      if (message.id != null && message.hasOwnProperty("id")) writer.uint32( /* id 1, wireType 2 =*/10).bytes(message.id);
	      if (message.isPrivate != null && message.hasOwnProperty("isPrivate")) writer.uint32( /* id 2, wireType 0 =*/16).bool(message.isPrivate);
	      if (message.isOnline != null && message.hasOwnProperty("isOnline")) writer.uint32( /* id 3, wireType 0 =*/24).bool(message.isOnline);
	      return writer;
	    };
	  ...
	  $root.JsonResponse = function () {
	    ...
	    JsonResponse.encode = function encode(message, writer) {
	      if (!writer) writer = $Writer.create();
	      if (message.json != null && message.hasOwnProperty("json")) writer.uint32( /* id 1, wireType 2 =*/10).string(message.json);
	      return writer;
	    };
	...
	class Connector extends EventTarget {
	  constructor(options = {}) {
	    ...
	    this.isLongPollingBlocked = false;
	  ...
	  scheduleReconnect(connectionDelay) {
	    var _this$logger;
	    const delay = connectionDelay != null ? connectionDelay : this.getConnectionAttemptDelay(this.connectionAttempt);
	    if (this.reconnectTimeout) {
	      clearTimeout(this.reconnectTimeout);
	    }
	    (_this$logger = this.logger) == null ? void 0 : _this$logger.log(`Pull: scheduling reconnection in ${delay} seconds; attempt # ${this.connectionAttempt}`);
	  ...
	  scheduleRestoreWebSocketConnection() {
	    var _this$logger2;
	    (_this$logger2 = this.logger) == null ? void 0 : _this$logger2.log(`Pull: scheduling restoration of websocket connection in ${RESTORE_WEBSOCKET_TIMEOUT} seconds`);
	  ...
	  emitMessage(message) {
	    ...
	    if (message.extra.server_time_unix) {
	      var _this$config$server$t;
	      const timeShift = (_this$config$server$t = this.config.server.timeShift) != null ? _this$config$server$t : 0;
	  ...
	  onLongPollingOpen() {
	    ...
	    (_this$logger3 = this.logger) == null ? void 0 : _this$logger3.log('Pull: Long polling connection with push-server opened');
	  ...
	  onWebSocketOpen() {
	    ...
	    (_this$logger4 = this.logger) == null ? void 0 : _this$logger4.log('Pull: Websocket connection with push-server opened');
	    this.connectPromises.forEach(resolver => {
	      resolver.resolve();
	    });
	    this.connectPromises = [];
	  ...
	  onWebSocketDisconnect(e = {}) {
	    ...
	    if (this.isManualDisconnect) {
	      var _this$logger5;
	      (_this$logger5 = this.logger) == null ? void 0 : _this$logger5.logForce('Pull: Websocket connection with push-server manually closed');
	    } else {
	      var _this$logger6;
	      (_this$logger6 = this.logger) == null ? void 0 : _this$logger6.logForce(`Pull: Websocket connection with push-server closed. Code: ${e.code}, reason: ${e.reason}`);
	  ...
	  onLongPollingDisconnect(e = {}) {
	    ...
	    (_this$logger7 = this.logger) == null ? void 0 : _this$logger7.log(`Pull: Long polling connection with push-server closed. Code: ${e.code}, reason: ${e.reason}`);
	    if (!this.isManualDisconnect) {
	      this.scheduleReconnect();
	    }
	    this.isManualDisconnect = false;
	  ...
	  checkRevision(serverRevision) {
	    if (serverRevision > 0 && serverRevision !== REVISION) {
	      var _this$logger8;
	      (_this$logger8 = this.logger) == null ? void 0 : _this$logger8.log(`Pull revision changed from ${REVISION} to ${serverRevision}. Reload required`);
	...
	/* eslint-disable @bitrix24/bitrix24-rules/no-native-events-binding */
	class Worker {
	  // userId -> set of subscribed ports

	  constructor() {
	    this.consumers = [];
	    this.userSubscriptions = new Map();
	    this.status = PullStatus.Online;
	    this.onRevisionChanged = e => {
	      this.consumers.forEach(consumer => {
	        consumer.rpcAdapter.executeOutgoingRpcCommand('revisionChanged', {
	  ...
	  createConnector(config, restClient) {
	  ...
	  createRpcAdapter(port) {
	    ...
	    port.addEventListener('message', me => rpcAdapter.handleIncomingMessage(me.data));
	    return rpcAdapter;
	  }
	  createSender(port) {
	    return {
	  ...
	  removeConsumer(port) {
	    const consumerIndex = this.consumers.findIndex(consumer => consumer.port === port);
	    if (consumerIndex !== -1) {
	  ...
	  async restart(disconnectCode = CloseReasons.NORMAL_CLOSURE, disconnectReason = 'manual restart') {
	    ...
	    (_this$connector = this.connector) == null ? void 0 : _this$connector.disconnect(disconnectCode, disconnectReason);
	    try {
	  ...
	  async handleSendMessageBatch({
	    messageBatch
	  }) {
	    return this.connector.sendMessageBatch(messageBatch);
	  }
	  async handleSendMessageToChannels({
	    publicChannels,
	    moduleId,
	    command,
	    params,
	  ...
	  handleNotifyConfigTimestamp({
	    configTimestamp
	  }) {
	    var _this$configHolder;
	    const config = ((_this$configHolder = this.configHolder) == null ? void 0 : _this$configHolder.config) || {};
	  ...
	  handleNotifyOffline() {
	    ...
	    (_this$connector2 = this.connector) == null ? void 0 : _this$connector2.disconnect('1000', 'offline');
	  }
	  handleSetPublicIds({
	    publicIds
	  }) {
	  ...
	  handleGetConfig() {
	    return {
	      config: this.configHolder.config
	    };
	  }
	  createSubscribeUserStatusChangeHandler(port) {
	    return ({
	      userId
	    }) => {
	  ...
	  createUnsubscribeUserStatusChangeHandler(port) {
	    return ({
	      userId
	    }) => {
	      this.unsubscribeUserStatus(userId, port);
	  ...
	  createByeHandler(port) {
	    return () => {
	      this.removeConsumer(port);
	    };
	  }
	  unsubscribeUserStatus(userId, port) {
	    if (!this.userSubscriptions.has(userId)) {
	      return;
	    }
	  ...
	  sendConnectionStatus(rpcAdapter) {
	    rpcAdapter.executeOutgoingRpcCommand('connectionStatusChanged', {
	      status: this.status,
	      connectionType: this.connector.connectionType,
	      isJsonRpc: this.connector.isJsonRpc()
	    }, 0);
	  }
	  onConnectorMessage(e) {
	    this.consumers.forEach(consumer => {
	      consumer.rpcAdapter.executeOutgoingRpcCommand('incomingMessage', {
	        payload: e.detail
	      }, 0);
	    });
	  }
	  ...
	  onOffline() {
	    ...
	    (_this$connector3 = this.connector) == null ? void 0 : _this$connector3.disconnect('1000', 'offline');
	  }
	  onOnline() {
	    var _this$connector4;
	    this.logger.log('online');
	    (_this$connector4 = this.connector) == null ? void 0 : _this$connector4.connect();
	  }
	}
...
//# sourceMappingURL=pull.worker.bundle.js.map

...
class MembersNotInvitedTwoDays extends AbstractJob
{
	public const JOB_OFFSET = self::SECONDS_PER_DAY * 2;

	public function getType(): Type
	{
		return Type::MembersNotInvitedTwoDays;
	}
	...
	public function __invoke(): JobResult
	{
		...
		$notificationService->send(
			Loc::getMessage('SOCIALNETWORK_COLLAB_ONBOARDING_MEMBERS_NOT_INVITED_TWO_DAYS'),
			$this->userId,
			$this->collabId
		);

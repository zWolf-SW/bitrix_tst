...
(function (exports,main_core,ui_dexie,im_v2_const,im_v2_application_core,rest_client,im_v2_lib_localStorage) {
	'use strict';
	...
	class SmileManager {
	  ...
	  constructor() {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _localStorageManager)[_localStorageManager] = im_v2_lib_localStorage.LocalStorageManager.getInstance();
	    const {
	      lastUpdate
	  ...
	  async initSmileList() {
	    try {
	      ...
	      if (shouldRequestFromServer) {
	        ...
	        babelHelpers.classPrivateFieldLooseBase(this, _localStorageManager)[_localStorageManager].set(im_v2_const.LocalStorageKey.smileLastUpdateTime, babelHelpers.classPrivateFieldLooseBase(this, _lastUpdateTime)[_lastUpdateTime]);
	      } else {
	      ...
	      babelHelpers.classPrivateFieldLooseBase(this, _localStorageManager)[_localStorageManager].remove(im_v2_const.LocalStorageKey.smileLastUpdateTime);
	    }
	  }
	...
	async function _fetchDataFromServer2() {
	  const result = await babelHelpers.classPrivateFieldLooseBase(this, _restClient)[_restClient].callMethod(im_v2_const.RestMethod.imSmilesGet, {
	    FULL_TYPINGS: 'Y'
	  });
	...
	function _shouldRequestFromServer2() {
	  const lastUpdateTimeFromStorage = babelHelpers.classPrivateFieldLooseBase(this, _localStorageManager)[_localStorageManager].get(im_v2_const.LocalStorageKey.smileLastUpdateTime);

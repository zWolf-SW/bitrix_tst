...
(function (exports,im_v2_lib_utils,im_v2_application_core,im_v2_const,im_v2_lib_smileManager,imopenlines_v2_lib_openlines) {
	...
	class MessageComponentManager {
	  constructor(message) {
	    ...
	    Object.defineProperty(this, _isDemoComponent, {
	      value: _isDemoComponent2
	    });
	  ...
	  getName() {
	    const openLinesMessageName = imopenlines_v2_lib_openlines.OpenLinesManager == null ? void 0 : imopenlines_v2_lib_openlines.OpenLinesManager.getMessageName(babelHelpers.classPrivateFieldLooseBase(this, _message)[_message]);
	...
	function _isDemoComponent2() {
	  return demoComponentList.has(babelHelpers.classPrivateFieldLooseBase(this, _message)[_message].componentId);
	}
	function _hasFiles2() {

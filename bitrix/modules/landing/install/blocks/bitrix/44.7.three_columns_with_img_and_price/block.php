		...
		<div class="row landing-block-inner">
			<div class="landing-block-node-card js-animation fadeInLeft col-md-6 col-lg-4 g-mb-30">
				...
				<article class="h-100 text-center u-block-hover u-block-hover__additional--jump g-brd-around g-bg-gray-light-v5 g-brd-gray-light-v4 d-flex flex-column">
					...
					<!-- Article Image -->
					<img class="landing-block-node-card-img g-height-230 w-100 g-object-fit-cover"
						 src="https://cdn.bitrix24.site/bitrix/images/landing/business/740x380/img1.jpg" alt="">
					<!-- End Article Image -->

					<!-- Article Content -->
					<div class="landing-block-node-card-container-bottom flex-grow-1 g-pa-40 d-flex flex-column">
						<div class="g-mb-15">
							<div class="landing-block-node-card-price-subtitle g-color" style="--color: hsla(0, 0%, 29%, 1);">
								From
							</div>
						...
						<div class="landing-block-node-card-text g-mb-40 g-color" style="--color: hsla(0, 0%, 29%, 1);">
			...
			<div class="landing-block-node-card js-animation fadeInLeft col-md-6 col-lg-4 g-mb-30">
				...
				<article class="h-100 text-center u-block-hover u-block-hover__additional--jump g-brd-around g-bg-gray-light-v5 g-brd-gray-light-v4 d-flex flex-column">
					...
					<!-- Article Image -->
					<img class="landing-block-node-card-img g-height-230 w-100 g-object-fit-cover"
						 src="https://cdn.bitrix24.site/bitrix/images/landing/business/740x380/img2.jpg" alt="">
					<!-- End Article Image -->
			...
			<div class="landing-block-node-card js-animation fadeInLeft col-md-6 col-lg-4 g-mb-30">
				...
				<article class="h-100 text-center u-block-hover u-block-hover__additional--jump g-brd-around g-bg-gray-light-v5 g-brd-gray-light-v4 d-flex flex-column">
					...
					<!-- Article Image -->
					<img class="landing-block-node-card-img g-height-230 w-100 g-object-fit-cover"
						 src="https://cdn.bitrix24.site/bitrix/images/landing/business/740x380/img3.jpg" alt="">
					<!-- End Article Image -->

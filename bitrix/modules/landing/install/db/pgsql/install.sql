...
CREATE INDEX ix_b_landing_copilot_generations_site_id ON b_landing_copilot_generations (site_id);
...
CREATE INDEX ix_b_landing_copilot_requests_generation_id_step ON b_landing_copilot_requests (generation_id);
CREATE INDEX ix_b_landing_copilot_requests_hash ON b_landing_copilot_requests (hash);
...
CREATE INDEX ix_b_landing_copilot_steps_generation_id ON b_landing_copilot_steps (generation_id);
...
CREATE INDEX ix_b_landing_copilot_request_to_entities_request_id ON b_landing_copilot_request_to_entities (request_id);
...
CREATE INDEX ix_b_landing_copilot_request_to_step_request_generation_step ON b_landing_copilot_request_to_step (request_id, generation_id, step);
...
CREATE INDEX ix_b_landing_copilot_b_landing_copilot_site_to_chat_site_id ON b_landing_copilot_site_to_chat (site_id);

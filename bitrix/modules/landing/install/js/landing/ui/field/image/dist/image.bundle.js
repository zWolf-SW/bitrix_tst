...
(function (exports,main_core,landing_loc,landing_main,landing_metrika,landing_ui_panel_stylepanel,landing_ui_field_textfield,landing_imageuploader,landing_ui_button_basebutton,landing_ui_button_aiimagebutton,landing_env) {
	...
	var Image = /*#__PURE__*/function (_TextField) {
	  ...
	  function Image(data) {
	    ...
	    babelHelpers.defineProperty(babelHelpers.assertThisInitialized(_this), "isEditorSaved", false);
	    ...
	    _this.onEditorClose = main_core.Runtime.debounce(_this.onEditorClose, 1000, babelHelpers.assertThisInitialized(_this));
	    ...
	    _this.metrika = new landing_metrika.Metrika(true);
	    return _this;
	  }
	  ...
	  babelHelpers.createClass(Image, [{
	    ...
	    value: function imageCopilotSaveImageHandler() {
	      var _url$searchParams$get,
	        _this2 = this;
	      var url = new URL(this.imageCopilotUrl);
	      var name = (_url$searchParams$get = url.searchParams.get('hashId')) !== null && _url$searchParams$get !== void 0 ? _url$searchParams$get : main_core.Text.getRandom(8);
	      BX.Landing.Utils.urlToBlob(url.href).then(function (blob) {
	        var ext = blob.type === 'image/png' ? '.png' : '.jpg';
	        blob.lastModifiedDate = new Date();
	        blob.name = "".concat(name, ".").concat(ext);
	        return blob;
	    ...
	    key: "sendAnalytic",
	    value: function sendAnalytic(event) {
	      var _contexts;
	      var contexts = (_contexts = {}, babelHelpers.defineProperty(_contexts, Image.CONTEXT_TYPE_CONTENT, 'sites_editor'), babelHelpers.defineProperty(_contexts, Image.CONTEXT_TYPE_STYLE, 'sites_designer'), babelHelpers.defineProperty(_contexts, Image.CONTEXT_TYPE_SETTINGS, 'sites_settings'), _contexts);
	      var contextSection = contexts[this.contextType] || 'sites_editor';
	    ...
	    value: function edit(data) {
	      ...
	      parent.BX.Landing.ImageEditor.edit({
	        ...
	        return _this4.upload(file, {
	          context: "imageEditor"
	        });
	      }).then(function (result) {
	        _this4.isEditorSaved = true;
	        _this4.onEditorClose();
	...
	babelHelpers.defineProperty(Image, "CONTEXT_TYPE_SETTINGS", 'settings');

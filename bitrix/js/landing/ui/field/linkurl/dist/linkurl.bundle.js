...
(function (exports,landing_ui_field_textfield,main_core,ui_entitySelector) {
	...
	class LinkUrl extends landing_ui_field_textfield.Text {
	  constructor(data) {
	    ...
	    main_core.Dom.addClass(this.layout, "landing-ui-field-link-url");
	    this.requestOptions = data.options || {};
	    this.disableBlocks = main_core.Type.isBoolean(data.disableBlocks) ? data.disableBlocks : false;
	...
	LinkUrl.TYPE_CRM_FORM = "crmFormPopup";
	LinkUrl.TYPE_CRM_PHONE = "crmPhone";
	LinkUrl.TYPE_SYSTEM = "system";
	LinkUrl.TYPE_CATALOG = "catalog";
	LinkUrl.TYPE_CATALOG_ELEMENT = "element";
	LinkUrl.TYPE_CATALOG_SECTION = "section";
	LinkUrl.TYPE_DISK_FILE = "diskFile";
	LinkUrl.TYPE_USER = "user";
	LinkUrl.TYPE_HREF_START = "selectActions:";
	LinkUrl.TYPE_HREF_PAGE = "page:";
	LinkUrl.TYPE_HREF_BLOCK = "block:";
	LinkUrl.TYPE_HREF_CRM_FORM = "form:";
	LinkUrl.TYPE_HREF_PRODUCT = "product:";
	LinkUrl.TYPE_HREF_TEL = "tel:";
	LinkUrl.TYPE_HREF_SMS = "sms:";
	LinkUrl.TYPE_HREF_MAILTO = "mailto:";
	LinkUrl.TYPE_HREF_SKYPE = "skype:";
	LinkUrl.TYPE_HREF_LINK = "";
	LinkUrl.TYPE_HREF_FILE = "file:";
	LinkUrl.TYPE_HREF_USER = "user:";
	LinkUrl.DELETE_TYPE_HREF = "deleteTypeHref";

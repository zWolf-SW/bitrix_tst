...
$MESS['BPWFI_SLIDER_MODIFIED'] = 'Активность';
$MESS['BPWFI_SLIDER_STATUS'] = 'Статус';
$MESS['BPWFI_SLIDER_NOT_MY_TASK'] = 'Вы открыли задание сотрудника #USER#';
$MESS['BPWFI_SLIDER_NOT_MY_PROCESS'] = 'Вы открыли процесс сотрудника #USER#';
...
$MESS['BPWFI_SLIDER_ARGUMENT_NULL'] = "Не заполнено обязательное поле '#PARAM#'";

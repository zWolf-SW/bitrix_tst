...
if ($arResult["IBLOCK_ID"])
{
	$listAction[] = [
		...
		"onclick" => new \Bitrix\UI\Buttons\JsCode(
			...
			GetMessage("CT_BLLE_TOOLBAR_DELETE_WARNING" . $typeTranslation . '_1') . "')"
		),
	];
...
<script>
	BX(function()
	{
		...
		BX.message({
			...
			CT_BLLE_DELETE_POPUP_TITLE: '<?=GetMessageJS("CT_BLLE_DELETE_POPUP_TITLE_1")?>',
			...
			CT_BLLE_COPY_POPUP_TITLE: '<?=GetMessageJS("CT_BLLE_COPY_POPUP_TITLE_1")?>',
			CT_BLLE_COPY_POPUP_CONTENT: '<?=GetMessageJS("CT_BLLE_COPY_POPUP_TEXT" . $typeTranslation)?>',
			CT_BLLE_DELETE_CONFIRM_BUTTON: '<?=GetMessageJS("CT_BLLE_DELETE_CONFIRM_BUTTON")?>',
			CT_BLLE_COPY_CONFIRM_BUTTON: '<?=GetMessageJS("CT_BLLE_COPY_CONFIRM_BUTTON")?>',

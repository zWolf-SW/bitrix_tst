...
/** @var \Bitrix\MessageService\Sender\Sms\SmscUa $sender */
$sender = $arResult['sender'];

?>
<div class="sms-settings">
	<h2 class="sms-settings-title">smsc.ua</h2>
		...
		<?php if (!$sender->isRegistered()):?>
			<div class="sms-settings-step-section">
				...
				<form action="" method="post" class="sms-settings-step-form" name="form_sms_registration">
					...
					<div class="sms-settings-input-container">
						<label for="" class="sms-settings-input-label">Psw*</label>
						<input type="text" name="psw" class="sms-settings-input">
					</div>
					<div class="sms-settings-input-container">
	...
	BX.ready(function()
	{
		...
		if (registrationForm)
		{
			...
			BX.bind(registrationForm, 'submit', function(e)
			{
				...
				var psw = registrationForm.elements['psw'].value;

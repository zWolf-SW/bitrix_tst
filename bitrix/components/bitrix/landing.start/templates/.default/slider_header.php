...
<head>
	<script>
		...
		{
			window.location = "<?= \CUtil::JSEscape($APPLICATION->GetCurPageParam('',
				array('IFRAME', 'IFRAME_TYPE')));?>";
		}
	</script>
	<? $APPLICATION->ShowHead(); ?>
</head>
<body class="template-<?= defined('SITE_TEMPLATE_ID') ? SITE_TEMPLATE_ID : '' ?><?php $APPLICATION->ShowProperty('BodyClass'); ?>">
<div class="landing-slider-pagetitle-wrap">
	<div class="landing-slider-pagetitle-inner-container">
		...
		<div class="landing-slider-pagetitle">
			<div id="pagetitle" class="landing-slider-pagetitle-title">
				<? $APPLICATION->ShowTitle(false); ?>
			</div>
			<div class="landing-slider-pagetitle-actions">

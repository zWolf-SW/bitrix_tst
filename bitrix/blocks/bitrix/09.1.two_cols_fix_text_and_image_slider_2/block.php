<section class="landing-block g-pt-50 g-pb-30">
	<div class="container">
		<div class="row">
			<div class="landing-block-node-carousel-container js-animation fadeInLeft col-lg-8 order-2 order-md-1" data-slider-autoplay-speed="5000" data-slider-slides-show="2" data-slider-arrows="1" data-slider-dots="0" data-slider-animation="1">
				<div class="landing-block-node-carousel js-carousel g-line-height-0 row"
					 ...
					 data-rows="2"
					 data-slides-show="2"
					 data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-100x g-right-0 g-width-35 g-mb-5 g-height-35 g-transition-0_2 g-transition--ease-in g-color-gray g-color-white--hover g-bg-gray-light-v5 g-bg-primary--hover"
			...
			<div class="landing-block-node-text-container d-flex js-animation fadeInRight col-lg-4 g-mb-40 g-mb-0--lg order-1 order-md-2">
				<div>
					<div class="landing-block-node-header text-uppercase u-heading-v2-4--bottom text-left g-brd-primary g-mb-20 g-border-color" style="--border-color: var(--primary);">
						<h6 class="landing-block-node-subtitle g-font-weight-700 g-letter-spacing-1 g-color g-mb-20" style="--color: var(--primary);">Our projects</h6>
						<h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-700 g-color">We are the
							<br> best</h2>
					</div>
					<div class="landing-block-node-text g-color">

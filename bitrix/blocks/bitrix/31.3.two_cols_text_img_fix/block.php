	...
	<div class="landing-block-node-container container g-pt-30 g-pb-30">
		<div class="row landing-block-node-block">
			<div class="landing-block-node-text-container js-animation slideInLeft col-md-6 col-lg-6 g-pb-20 g-pb-0--md">
				<h2 class="landing-block-node-title text-uppercase g-font-weight-700 mb-0 g-mb-20 g-color">
				...
				<div class="landing-block-node-text g-color">
					...
					<p>
						...
						rutrum ipsum in quam semper laoreet. Praesent dictum nulla id viverra vehicula. Vestibulum ante
					...
					<p>
						...
						fermentum, ipsum ac facilisis elementu.
					</p>
				</div>
			</div>
